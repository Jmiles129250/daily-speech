...
def build_user_prompt(date_str: str, forbidden_titles: list[str]) -> str:
    ...
    buckets = [
        ...
        # --- 近代中国(1840-1949)---
        "晚清民国:1840-1949 年间的一则真实历史片段(林则徐虎门销烟、曾国藩组建湘军、"
        "左宗棠收复新疆、张謇办实业、严复译《天演论》、梁启超办《时务报》、"
        "詹天佑修京张铁路、蔡元培主北大、鲁迅弃医从文任选一),必须有明确年份与具体决定。",
        "近代中国变局:1840-1949 年间,某个个体在时代巨变中做出的非主流选择("
        "如:辜鸿铭留辫教西学、陈寅恪在抗战中护书、钱穆写《国史大纲》、"
        "梅贻琦执掌西南联大、张爱玲战后选择任选一),侧重个人在洪流中的姿态。",
        # --- 现代中国(1949 至今)---
        "现代中国:1949 年后中国土地上发生的一则真实故事("
        "两弹一勋、女排五连冠、改革开放第一代企业家如柳传志张瑞敏、"
        "袁隆平数十年选种、钟南山 03 与 20 的两次出山任选一),"
        "时代背景与人物角色要交代清楚,不要靠杜撰。",
        "当代华人世界:1980 年后中国及海外华人社会里一则可考的真实片段("
        "比如 1992 邓小平南巡、1998 抗洪、2008 汶川救灾、2010 上海世博会、"
        "2020 抗疫、华为备胎计划、SpaceX 早期华人工程师任选一),"
        "突出面对逆境的选择与代价。",
        # --- 西方 ---
        "西方近现代:1800 年后一则真实历史片段(达尔文华莱士的进化论优先权之争、"
        "爱因斯坦专利局岁月、居里夫人在波兰的求学、香奈儿二战期间的争议、"
        "图灵的一生、曼德拉 27 年牢狱任选一),"
        "讲述者应该用中文现代汉语,事例是西方的。",
        "思想史切片:选一位思想家(韩非、董仲舒、朱熹、王阳明、培根、笛卡尔、"
        "尼采、加缪、波伏娃、哈耶克)的一则人生小场景(不是讲思想,讲人),"
        "让他们的人生决定给当下人启发。",
    ]
